...
@InputType()
class RecommendationCreateNestedManyWithoutBriefsInput {
...
export { RecommendationCreateNestedManyWithoutBriefsInput as RecommendationCreateNestedManyWithoutBriefsInput };
