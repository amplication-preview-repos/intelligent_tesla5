...
@InputType()
class RecommendationUpdateManyWithoutMusicItemsInput {
...
export { RecommendationUpdateManyWithoutMusicItemsInput as RecommendationUpdateManyWithoutMusicItemsInput };
