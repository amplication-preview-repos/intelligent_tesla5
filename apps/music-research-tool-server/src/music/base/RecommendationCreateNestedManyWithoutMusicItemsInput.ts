...
@InputType()
class RecommendationCreateNestedManyWithoutMusicItemsInput {
...
export { RecommendationCreateNestedManyWithoutMusicItemsInput as RecommendationCreateNestedManyWithoutMusicItemsInput };
